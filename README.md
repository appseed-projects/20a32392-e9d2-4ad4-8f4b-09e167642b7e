...
- 👉 [Complete documentation](https://docs.appseed.us/products/flask-apps/soft-ui-design) - `Learn how to use and update the product`
  - ✅ [Set up the environment](https://docs.appseed.us/products/flask-apps/soft-ui-design#environment)
  - ✅ [Start the app in Docker](https://docs.appseed.us/products/flask-apps/soft-ui-design#start-the-app-in-docker)
  - ✅ [Manual Build](https://docs.appseed.us/products/flask-apps/soft-ui-design#manual-build)
  - ✅ [UI Assets and Templates](https://docs.appseed.us/products/flask-apps/soft-ui-design#ui-assets-and-templates)
  - ✅ [Set up the MySql Database](https://docs.appseed.us/products/flask-apps/soft-ui-design#set-up-the-mysql-database)
  - ✅ [Static Assets for production](https://docs.appseed.us/products/flask-apps/soft-ui-design#static-assets-for-production)  
  
<br />

> Built with [Soft UI Design Generator](https://appseed.us/generator/soft-ui-design/)

- Timestamp: `2022-06-15 13:55`
- Build ID: `20a32392-e9d2-4ad4-8f4b-09e167642b7e`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/20a32392-e9d2-4ad4-8f4b-09e167642b7e.git
$ cd 20a32392-e9d2-4ad4-8f4b-09e167642b7e
```
